...
public class ServicioClienteTest {
    ...
    void setUp() {
        ...
        cliente1 = new Cliente("1234567890", "Juan", "Perez");
        cliente2 = new Cliente("0987654321", "Maria", "Gomez");
    }
    ...
    void testActualizarClienteExistente() {
        servicio.crear(cliente1);
        Cliente clienteActualizado = new Cliente("1234567890", "Carlos", "Rodriguez");
    ...
    void testActualizarClienteNoExistente() {
        Cliente clienteActualizado = new Cliente("9999999999", "Carlos", "Rodriguez");
    ...
    void testCrearMultiplesClientes() {
        servicio.crear(cliente1);
        servicio.crear(cliente2);
        Cliente cliente3 = new Cliente("5555555555", "Pedro", "Lopez");
